...
Natural language is not a strict API. It supports incomplete, ambiguous, contextual, socially aware communication. See [Layer 0 Natural Language Properties]({{< ref "ai-engineering/causal-stack/layer-0-natural-language-properties" >}})
