...
For the fuller balancing method, see [Coverage and Case Design]({{< ref "ai-engineering/evaluation/v1/coverage-and-case-design" >}}). Grouping and sampling techniques can support the balancing process.
