...
*Foundations of Scalable Systems: Designing Distributed Architectures* by Ian Gorton, "O'Reilly Media, Inc.", 2022
...
You can use cache to reduce load on a target system (which data cache holds). Thus allowing another parts of the system to be scaled effectively. [Caching]({{< ref "engineering/topics/caching" >}})
