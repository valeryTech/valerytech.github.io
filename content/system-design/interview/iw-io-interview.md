...
#todo implement and use in practice a structured approach to breaking down complex problems [Approach]({{< ref "system-design/frameworks/problem-solving-approach" >}})
...
we can introduce here product approach as in [Url Shortener]({{< ref "system-design/projects/url-shortener/url-shortener" >}})
...
<https://www.reddit.com/r/ExperiencedDevs/comments/1i57tmt/deleted_by_user/>
