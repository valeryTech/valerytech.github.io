...
This page will try to reload once the service is available, or you can try to refresh the page yourself.
...
In this lesson, you'll pipe the analytics data from Redpanda into a real-time data warehouse called [Clickhouse](https://github.com/ClickHouse/ClickHouse
